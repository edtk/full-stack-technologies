...
### Нумерованный список
> Нумерованный список создается путем добавления номера и точки после него. Так же вы можете создавать вложенные списки используя табуляцию.
...
> Вы можете использовать - (дефисы) или * (звездочки) для создания маркированного списка.
```markdown
* Пункт 1
* Пункт 2
  * Подпункт 2.2
